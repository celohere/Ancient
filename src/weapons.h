...
*/
	...
	class Weapon : public Event {
		public:
			...
			virtual int32_t getWeaponDamage(const Player* player, const Creature* target, const Item* item, bool maxDamage = false
			) const = 0;
			virtual int32_t getElementDamage(const Player*, const Creature*) const {
				return 0;
			}
		...
		protected:
			...
			virtual bool getSkillType(const Player*, const Item*, skills_t&, uint64_t&) const {
				return false;
			}
