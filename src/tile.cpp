...
ReturnValue Tile::__queryMaxCount(
	int32_t,
	const Thing*,
	uint32_t count,
...
ReturnValue Tile::__queryRemove(
	const Thing* thing,
	uint32_t count,
	uint32_t flags
) const {
...
Cylinder* Tile::__queryDestination(
	int32_t&,
	const Thing*,
	Item** destItem,
	uint32_t& flags
...
int32_t Tile::getClientIndexOfThing(
	const Player* player,
	const Thing* thing
) const {
...
void Tile::postRemoveNotification(
	Creature* actor,
	Thing* thing,
