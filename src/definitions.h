...
*/
	...
	#define SOFTWARE_NAME "Ancient"
	#define SOFTWARE_VERSION "1.0-f0b0" // 0 features, 0 bug fixes
	#define SOFTWARE_CODENAME "R3884_SVN-fork" // fork of https://github.com/otland/tfs-old-svn/releases/tag/r3884
