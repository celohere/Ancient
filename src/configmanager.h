	...
	class ConfigManager {
		public:
			...
			enum bool_config_t {
				...
				HIDE_SPELL_WORDS,
				PLAYER_CAN_BLOCK_MONSTER_SPAWN,
				REMOVE_SWORDSICON_IN_PROTECTION_ZONE,
				SOUL_REGENERATION_WORK_ANY_ZONE,
			...
			void getValue(
				...
				LuaInterface::getValue(key, L, _L);
			}
