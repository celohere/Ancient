...
*/
	...
	class IOBan {
		...
		public:
			...
			bool addIpBanishment(uint32_t ip, int64_t banTime, uint32_t reasonId, std::string comment, uint32_t gamemaster, uint32_t mask = 0xFFFFFFFF, std::string statement = "") const;
			bool addPlayerBanishment(uint32_t playerId, int64_t banTime, uint32_t reasonId, ViolationAction_t actionId, std::string comment, uint32_t gamemaster, PlayerBan_t type, std::string statement = "") const;
			bool addPlayerBanishment(std::string name, int64_t banTime, uint32_t reasonId, ViolationAction_t actionId, std::string comment, uint32_t gamemaster, PlayerBan_t type, std::string statement = "") const;
			bool addAccountBanishment(uint32_t account, int64_t banTime, uint32_t reasonId, ViolationAction_t actionId, std::string comment, uint32_t gamemaster, uint32_t playerId, std::string statement = "") const;
			bool addNotation(uint32_t account, uint32_t reasonId, std::string comment, uint32_t gamemaster, uint32_t playerId, std::string statement = "") const;
			bool addStatement(uint32_t playerId, uint32_t reasonId, std::string comment, uint32_t gamemaster, int16_t channelId = -1, std::string statement = "") const;
			bool addStatement(std::string name, uint32_t reasonId, std::string comment, uint32_t gamemaster, int16_t channelId = -1, std::string statement = "") const;
