...
// You should have received a copy of the GNU General Public License along with this program. If not, see <http:// www.gnu.org/licenses/>.
	...
	class Vocation {
		public:
			...
			void setFromVocation(int32_t v) {
				fromVocation = v;
			}
			...
			bool isPremiumNeeded() const {
				return needPremium;
			}
			void setNeedPremium(bool v) {
				needPremium = v;
			}
			...
			void setAttackSpeed(uint32_t v) {
				attackSpeed = v;
			}
			...
			void setBaseSpeed(uint32_t v) {
				baseSpeed = v;
			}

			int32_t getLessLoss() const {
				return lessLoss;
			}
			void setLessLoss(int32_t v) {
				lessLoss = v;
			}

			int32_t getGainCap() const {
				return capGain;
			}
			void setGainCap(int32_t v) {
				capGain = v;
			}
