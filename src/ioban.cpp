...
bool IOBan::addPlayerBanishment(
	uint32_t playerId,
	int64_t banTime,
	uint32_t reasonId,
...
bool IOBan::addAccountBanishment(
	uint32_t account,
	int64_t banTime,
	uint32_t reasonId,
	ViolationAction_t actionId,
...
bool IOBan::removePlayerBanishment(
	uint32_t guid,
	PlayerBan_t type
) const {
	Database* db = Database::getInstance();
...
bool IOBan::removeAccountBanishment(
	uint32_t account,
	uint32_t playerId
) const {
	Database* db = Database::getInstance();
...
uint32_t IOBan::getNotationsCount(
	uint32_t account,
	uint32_t playerId
) const {
	Database* db = Database::getInstance();
...
uint32_t IOBan::getStatementsCount(
	uint32_t playerId,
	int16_t channelId
) const {
	Database* db = Database::getInstance();
