...
*/
	...
	class ProtocolGame : public Protocol {
		...
		private:
			...
			void AddCreatureOutfit(
				NetworkMessage_ptr msg,
				const Creature* creature,
				const Outfit_t& outfit,
				bool outfitWindow = false
			);
