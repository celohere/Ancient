	...
	#include <sstream>
		...
		class _Database {
			public:
				...
				*/
				DATABASE_VIRTUAL bool getParam(DBParam_t) {
					return false;
				}
			...
			public:
				...
				* @return true on success, false on error
				*/
				DATABASE_VIRTUAL bool query(const std::string&) {
					return 0;
				}
				...
				*/
				DATABASE_VIRTUAL DBResult* storeQuery(const std::string&) {
					return 0;
				}
				...
				*/
				DATABASE_VIRTUAL std::string escapeString(const std::string&) {
					return "''";
				}
				...
				*/
				DATABASE_VIRTUAL std::string getStringComparer() {
					return "= ";
				}
		...
		class _DBResult {
			public:
				...
				*/
				DATABASE_VIRTUAL int32_t getDataInt(const std::string&) {
					return 0;
				}
				...
				*\param s The name of the field
				*/
				DATABASE_VIRTUAL int64_t getDataLong(const std::string&) {
					return 0;
				}
				...
				*\param s The name of the field
				*/
				DATABASE_VIRTUAL std::string getDataString(const std::string&) {
					return "''";
				}
